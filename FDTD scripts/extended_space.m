...
%{
    ...
    and plot it both in the desired region and in the extended region
...
% surf(r_sp_axis, r_sp_axis, r_sigma'); % plot to check if everything is ok
...
figure();clf;
h = imagesc(r_sp_axis,r_sp_axis,r_Ez');
set(gca, 'ydir', 'normal');
hold on
circle2(x0,y0,R);
